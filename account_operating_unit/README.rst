...
.. |badge2| image:: https://img.shields.io/badge/github-operating--unit-lightgray.png?logo=github
    :target: https://github.com/brain-tec/operating-unit/tree/15.0.project_MI_465/account_operating_unit
...
`feedback <https://github.com/brain-tec/operating-unit/issues/new?body=module:%20account_operating_unit%0Aversion:%2015.0.project_MI_465%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `brain-tec/operating-unit <https://github.com/brain-tec/operating-unit/tree/15.0.project_MI_465/account_operating_unit>`_ project on GitHub.
