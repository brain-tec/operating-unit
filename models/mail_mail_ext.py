    ...
    def create(self, vals_list):
        ...
        for mail in mails:
            ...
            if operating_unit and operating_unit.catchall_alias and operating_unit.catchall_domain:
                sender_email_address = (operating_unit.catchall_alias + '@' + operating_unit.catchall_domain)
                email_name = operating_unit.partner_id.name
                mail_from_reply_to = formataddr((email_name, sender_email_address))
                vals_to_write = {
                ...
                if operating_unit.outgoing_mail_server_id:
                    vals_to_write['mail_server_id'] = operating_unit.outgoing_mail_server_id.id
