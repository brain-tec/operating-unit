...
# FILE FULLY COMMENTED OUT, as it just contains a test that is disabled as we have
# _onchange_picking_type_id in purchase_operating_unit/purchase_order.py that will make
# it not fail
